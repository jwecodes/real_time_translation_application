...
import 'package:real_time_translation_application/screens/audio_calling_screen.dart';
import 'package:real_time_translation_application/screens/new_contact.dart';
import 'package:real_time_translation_application/screens/profile_screen.dart';
import 'package:real_time_translation_application/screens/contact_profile_screen.dart';
...
void _initiateCall() async {
  ...
  try {
    ...
    Future<String> getCallerPhoneNumber(String uid) async {
      try {
    ...
    String currentUserUid = FirebaseAuth.instance.currentUser!.uid;
    String callerPhoneNumber = await getCallerPhoneNumber(currentUserUid);
